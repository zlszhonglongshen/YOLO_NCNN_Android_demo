...
//        YoloV5::detector = new YoloV5(mgr,"MobileNetV2-YOLOv3-Nano-coco.param","MobileNetV2-YOLOv3-Nano-coco.bin");
        YoloV5::detector = new YoloV5(mgr,"faster.param","faster.bin");
    }
}
